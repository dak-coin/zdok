# Linearize
Construct a linear, no-fork, best version of the zdok blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install zdok_hash

https://github.com/zdokpay/zdok_hash
...
JSON-RPC server. Running `zdokd` or `zdok-qt -server` will be sufficient.
...
* `input`: zdokd blocks/ directory containing blkNNNNN.dat
