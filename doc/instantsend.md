...
This mechanism has been integrated into Bitcore-Node-zdok which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zdokpay/insight-api-zdok#web-socket-api](https://github.com/zdokpay/insight-api-zdok#web-socket-api)
* API: [https://github.com/zdokpay/insight-api-zdok#instantsend-transactions](https://github.com/zdokpay/insight-api-zdok#instantsend-transactions)
...
By default, the zdok Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the zdok Core daemon:
