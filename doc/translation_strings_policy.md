...
This document provides guidelines for internationalization of the zdok Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zdok_en.ts` remains unchanged.
