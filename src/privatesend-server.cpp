...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all zdok related functionality
...
/*
    ...
    allow endless transaction that would bloat zdok and make it unusable. To
