    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("zdok-light"), QVariant("light"));
    ui->theme->addItem(QString("zdok-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("zdok-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("zdok-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("zdok-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("zdok-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("zdok-traditional"), QVariant("trad"));
