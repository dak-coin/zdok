...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print zdok address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "zdok",               "masternode",             &masternode,             true,  {} },
    { "zdok",               "masternodelist",         &masternodelist,         true,  {} },
    { "zdok",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "zdok",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "zdok",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "zdok",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
